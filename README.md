...
after playing with CryptoKitties or just all the calories that you might burn while you try to trading with crypto using exchanges or simply because you're a developer and you need to feed yourself time to time. 
Here's an inspiring quote on ramen:
> The only men I need is Ramen - Anonymous
And here's another quote spreading wisom using ramen:
